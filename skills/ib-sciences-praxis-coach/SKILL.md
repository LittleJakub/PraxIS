...
6. **Add moderation-style comments** (as the TSM recommends): comments on the work help examiners understand the reasoning behind marks. Use `references/anti-patterns.md` to ensure every mark-capping pattern is explicitly addressed in the justification.
