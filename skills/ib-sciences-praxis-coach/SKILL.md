...
6. **Add moderation-style comments** (as the TSM recommends): comments on the work give moderators insight into why each mark was given. Use `references/anti-patterns.md` to ensure every mark-capping pattern is explicitly addressed in the justification.
